  ...
  return (
    <MobileDialogPortal>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          isMobile
            ? "fixed inset-0 z-50 flex flex-col w-full bg-white animate-in data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[state=closed]:slide-out-to-bottom-[48%] data-[state=open]:slide-in-from-bottom-[48%]"
